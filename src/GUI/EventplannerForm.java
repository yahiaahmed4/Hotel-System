...
public class EventplannerForm extends javax.swing.JFrame {
...
public static ArrayList<EventPlanner> ev=new ArrayList<EventPlanner>();
    /**
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(jTextField11, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(119, 119, 119))))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     double bounes=Double.parseDouble( jTextField9.getText().toString());
     ...
     int number=Integer.parseInt(jTextField12.getText().toString());
      String nathonalty= jTextField12.getText().toString();
        ...
        EventPlanner EV=new EventPlanner(bounes, deduction, address, id, name, nationaltyid, number, nathonalty, email, age, gender);
         EV.GetTotalSalary(bounes, deduction);
                String x;
     x=Double.toString(EV.GetTotalSalary(bounes, deduction));
  jTextField11.setText(x);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventplannerForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventplannerForm().setVisible(true);
            }
        });
    }
